    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const orderResponse = await axios.post(
                'https://saraicollection.pythonanywhere.com/api/orders',
                {},
                { headers: { Authorization: `Bearer ${token}` } }
            );
            ...
            payload.append('amount', Math.floor(orderSummary.total)); // Ensure integer amount

            const paymentResponse = await axios.post(
                'https://saraicollection.pythonanywhere.com/api/payments/mpesa',
                payload,
                {
                    headers: {
