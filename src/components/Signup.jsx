  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://saraicollection.pythonanywhere.com/api/auth/register',
        formDataToSend,
        {
      ...
      setTimeout(() => navigate('/'), 2000); // Redirect to home instead of signin
    } catch (error) {
          ...
          <form onSubmit={handleSubmit} noValidate>
            {loading && (
              <div className="alert alert-info">
                <FaSpinner className="fa-spin me-2" /> Creating your account...
              </div>
            )}
            ...
            >
              {loading ? (
                <>
                  <FaSpinner className="fa-spin me-2" /> Creating Account...
                </>
              ) : (
                'Sign Up'
              )}
